  ...
  return (
    <div className="border-t border-slate-200 bg-white p-4">
      ...
      <div className="flex items-end gap-2">
        ...
        <textarea
          className="max-h-32 min-h-[2.5rem] flex-1 resize-none rounded-lg border border-slate-300 px-3 py-2 focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 disabled:bg-slate-100"
